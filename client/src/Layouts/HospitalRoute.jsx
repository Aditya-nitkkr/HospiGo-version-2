...
export const HospitalRoute = () => {
    ...
    const matchesSearchedHospital = location.state?.hospitalId === id;

    if (!cameFromSearch || !matchesSearchedHospital) {
        toast.error("Please select a hospital from search first");
